...
class JogoDaVelha
{
    ...
    static void Main(string[] args)
    {
        ...
        while (!sairDoJogo)
        {
            ...
            // MODIFICAÇÃO: Reinicia o placar de forma diferente dependendo do modo
            if (modoJogoAtual != opcaoMenu)
            {
                if (opcaoMenu == 1) // Jogador vs Jogador
                {
                    // Reseta apenas o placar do computador
                    pontuacaoComputador = 0;
                }
                else if (opcaoMenu == 2) // Jogador vs Computador
                {
                    // Reseta o placar inteiro
                    ZerarPlacar();
                }
